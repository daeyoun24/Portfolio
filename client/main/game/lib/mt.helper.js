...
(function (global) {
    ...
    var mt = global.mt = {
        ...
        init: function (game) {
            ...
            if (min == 0) {
                this.game.load.script("hacks", "/js/phaserHacks2.0.js");
            }
            else if (min == 1) {
                this.game.load.script("hacks", "/js/phaserHacks2.1.js");
            }
            else if (min == 2) {
                this.game.load.script("hacks", "/js/phaserHacks2.2.js");
            }
            else {
                this.game.load.script("hacks", "/js/phaserHacks.js");
            }
